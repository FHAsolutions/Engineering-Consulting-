  ...
  return (
    <div className="relative w-full h-96">
      <div className="relative z-10 flex flex-col h-full text-white">
        ...
        <p className='ml-12 mb-4'>At FHA, Solutions Inc we are committed to every phase of our projects, from initial concept to final delivery because we <br/> know that every decision has an impact.</p>
        <div>
